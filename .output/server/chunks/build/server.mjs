...
import { toRef, isRef, defineComponent, ref, inject, h, Suspense, computed, Fragment, hasInjectionContext, getCurrentInstance as getCurrentInstance$1, shallowRef, provide, shallowReactive, createElementBlock, cloneVNode, defineAsyncComponent, unref, createApp, createVNode, Text, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, effectScope, mergeProps, getCurrentScope, withCtx, nextTick, isReadonly, toValue, useSSRContext, isShallow, isReactive, toRaw, customRef } from 'vue';
import { x as parseURL, y as encodePath, z as decodePath, A as hasProtocol, B as isScriptProtocol, w as joinURL, C as withQuery, D as sanitizeStatusCode, E as getContext, F as parsePath, G as parseQuery, $ as $fetch$1, H as baseURL, I as defu, q as createError$1, J as executeAsync, K as hash, L as getRequestURL, M as getRequestHeader, N as getCookie, O as klona, P as isEqual, Q as createDefu, R as setCookie, S as deleteCookie, T as withoutTrailingSlash, U as isEqual$1 } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index___ar",
    path: "/",
    component: () => import('./index-B3lGrVtM.mjs')
  },
  {
    name: "index___en",
    path: "/en",
  ...
  ar: [
    {
      ...
      load: () => import(
        './ar-CzUcvsLd.mjs'
        /* webpackChunkName: "locale_ar_46json_de293923" */
      ),
      cache: true
    }
  ],
  en: [
    {
      ...
      load: () => import(
        './en-C61BbygO.mjs'
        /* webpackChunkName: "locale_en_46json_3775d669" */
      ),
      cache: true
    }
  ]
...
function createNuxtI18nContext(nuxt, vueI18n, defaultLocale) {
  ...
  const loadMessagesFromServer = async (locale) => {
    ...
    const messages = await $fetch(`${"/_i18n/nDuqWsTT"}/${locale}/messages.json`, { headers });
...
const i18n_EI7LsD1KYQADczz5hrChviGQCdVM8yUkvFEZLJpmnvM = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(_nuxt) {
    ...
    prerenderRoutes(localeCodes.map((locale) => `${"/_i18n/nDuqWsTT"}/${locale}/messages.json`));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-CBsKjxjD.mjs').then((m) => m.default || m)),
  website: defineAsyncComponent(() => import('./website-BH4Llcra.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DfZUjmgl.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CiD2JTyz.mjs'));
...
export { _export_sfc as _, useI18n as a, useState as b, useSwitchLocalePath as c, __nuxt_component_0 as d, entry_default as default, useRouter as e, encodeRoutePath as f, useNuxtApp as g, useRuntimeConfig as h, nuxtLinkDefaults as i, navigateTo as n, resolveRouteObject as r, useHead as u };
