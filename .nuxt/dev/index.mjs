...
var courses$1 = {
	...
	categories: {
		all: "الكل",
		drawing: "رسم وفنون بصرية",
		arts_crafts: "فنون ونحت",
		music: "موسيقى",
		handmade: "أعمال يدوية",
		workshops: "ورش يومية"
	},
	details: {
		age: "السن",
		materials: "الخامات",
		included: "شاملة الخامات",
		notIncluded: "غير شاملة الخامات",
		academic: "منهج أكاديمي",
		prerequisite: "المتطلبات",
		ageRange: "الفئة العمرية",
		materialsTitle: "الأدوات والخامات",
		descriptionTitle: "عن الكورس",
...
var testimonials$1 = {
	...
	reviews: [
		...
		{
			text: "الاهتمام بالتفاصيل وطرق التدريس الاحترافية تجعل كل حصة تجربة ممتعة ومفيدة جداً.",
			name: "ليلى أحمد",
			role: "طالبة موسيقى"
		}
	]
...
var courses = {
	...
	categories: {
		...
		arts_crafts: "Arts & Sculpture",
		music: "Music",
		handmade: "Handmade",
		workshops: "Daily Workshops"
	},
	details: {
		age: "Age",
		materials: "Materials",
		included: "Materials Included",
		notIncluded: "Materials Not Included",
		academic: "Academic Curriculum",
		prerequisite: "Prerequisite",
		ageRange: "Age Range",
		materialsTitle: "Materials & Tools",
		descriptionTitle: "About the Course",
...
var testimonials = {
	...
	reviews: [
		...
		{
			text: "The attention to detail and professional teaching methods make every session a joy.",
			name: "Laila Ahmed",
			role: "Music Student"
		}
	]
